...
public class FigureIcon implements Icon {
	...
	public void paintIcon(Component c, Graphics g, int x, int y) {
		...
		if (figureType.equals(DrawerView.figureType[0])) { //point
		...
		} else if (figureType.equals(DrawerView.figureType[5])) { //circle
			g.drawOval(x, y, WIDTH, HEIGHT);
		} else if (figureType.equals(DrawerView.figureType[6])) { //saturn
			g.drawOval(x, y, WIDTH, HEIGHT);
			g.drawArc(x-3, y+2, WIDTH*4/3+1, HEIGHT-5, 130, 280);
		} else if (figureType.equals(DrawerView.figureType[7])) { //tv
		...
		} else if (figureType.equals(DrawerView.figureType[8])) { //kite
			g.drawLine(x, y, x+WIDTH, y+HEIGHT);
			...
			g.drawRect(x, y, WIDTH, HEIGHT);
		} else if (figureType.equals(DrawerView.figureType[9])) { //text
